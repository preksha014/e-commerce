        ...
        <div class="w-full max-w-lg p-6 bg-white shadow-md rounded-lg border border-gray-300">
            ...
            <form action="{{ route('admin.product.store') }}" method="POST" enctype="multipart/form-data">
                ...
                <div class="mt-3">
                    ...
                    <textarea id="description" name="description" required class="w-full mt-1 p-2 border rounded-md"></textarea>
                </div>
                <div class="mt-3">
                ...
                <div class="grid grid-cols-2 gap-3 mt-3">
                    <div>
                        ...
                        <input type="number" id="price" name="price" step="0.01" required class="w-full mt-1 p-2 border rounded-md">
                    </div>
                    <div>
                        <label for="quantity" class="block text-sm font-medium text-gray-700">Quantity</label>
                        <input type="number" id="quantity" name="quantity" required class="w-full mt-1 p-2 border rounded-md">
                    </div>
                </div>
                <div class="mt-3">
                ...
                <div class="mt-3">
                    ...
                    <input type="file" id="images" name="images[]" multiple required class="w-full mt-1 p-2 border rounded-md">
                </div>
