<x-dashboard-layout>
    <x-slot:heading>Permissions</x-slot:heading>
    ...
    <div class="p-8 space-y-8">
        ...
        <div class="flex flex-col sm:flex-row justify-between items-start sm:items-center space-y-4 sm:space-y-0 bg-white p-6 rounded-xl shadow-sm">
            <div>
                <h2 class="text-2xl font-semibold text-gray-800">Permissions Management</h2>
            </div>
                        ...
                        @foreach ($permissions as $permission)
                            <tr class="hover:bg-gray-50">
                                ...
                                <td class="px-6 py-4">
                                    ...
                                    <a href="{{ route('admin.permission.edit',$permission->id) }}" class="p-2 bg-violet-50 text-violet-600 rounded-lg hover:bg-violet-100 transition-colors duration-200">
                                        <i class="fa-solid fa-pen-to-square"></i>
                                    </a>
                                    <button type="button"
                                            class="p-2 bg-red-50 text-red-600 rounded-lg hover:bg-red-100 transition-colors duration-200"
                                            data-action-open data-id="{{ $permission->id }}">
    ...
    <div id="deleteModal" class="fixed inset-0 bg-black bg-opacity-50 flex items-center justify-center hidden">
        <div class="bg-white p-6 rounded-lg shadow-lg">
            ...
            <p class="text-gray-600">Do you really want to delete this permission? This action cannot be undone.</p>
...
<script>
    $(document).ready(function () {
        ...
        $('[data-action-open]').click(function () {
            ...
            $('#deleteForm').attr('action', '/admin/permission/' + permissionId + '/delete');
