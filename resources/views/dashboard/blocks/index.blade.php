<x-dashboard-layout>
    ...
    <div class="p-8 space-y-8">
        ...
        <div class="flex flex-col sm:flex-row justify-between items-start sm:items-center space-y-4 sm:space-y-0 bg-white p-6 rounded-xl shadow-sm">
            <div>
                <h2 class="text-2xl font-semibold text-gray-800">Blocks Management</h2>
            </div>
                ...
                <tbody class="divide-y divide-gray-200">
                    @foreach ($data as $block)
                        <tr class="hover:bg-gray-50 transition-colors duration-200">
                            ...
                            <td class="px-6 py-4">
                                <div class="text-sm text-gray-500">{{ $block->slug }}</div>
                            </td>
                            <td class="px-6 py-4">
                                <span class="px-2 inline-flex text-xs leading-5 font-semibold rounded-full {{ $block->status ? 'bg-green-100 text-green-800' : 'bg-red-100 text-red-800' }}">
