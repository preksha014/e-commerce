              ...
              <tr class="h-[100px] border-b">
                <td class="align-middle">
                  <div class="flex">
                    <img
                      class="w-[90px]"
                      src="{{ asset('src/assets/images/bedroom.png') }}"
                      alt="bedroom image"
                    />
              ...
              <tr class="h-[100px] border-b">
                <td class="align-middle">
                  <div class="flex">
                    <img
                      class="w-[90px]"
                      src="{{ asset('src/assets/images/product-chair.png')}}"
                      alt="Chair Image"
                    />
                    <div class="ml-3 flex flex-col justify-center">
              ...
              <tr class="h-[100px] border-b">
                <td class="align-middle">
                  <div class="flex">
                    <img
                      class="w-[90px]"
                      src="{{ asset('src/assets/images/outdoors.png')}}"
              ...
              <tr class="h-[100px]">
                <td class="align-middle">
                  <div class="flex">
                    <img
                      class="w-[90px]"
                      src="{{ asset('src/assets/images/matrass.png')}}"
                      alt="Matrass Image"
                    />
                    <div class="ml-3 flex flex-col justify-center">
