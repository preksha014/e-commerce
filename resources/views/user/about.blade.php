<x-layout>
        ...
        {{-- <div class="relative">
          <img
            ...
            src="{{ asset('src/assets/images/about-us-bg.jpeg') }}"
      ...
      <section class="flex-grow">
        <div class="mt-6 flex flex-col gap-3">
          <img
            ...
            src="{{ asset('src/assets/images/company-logo.svg')}}"
            alt="Maybell Logo"
          />
        ...
        >
          ...
          <div class="grid grid-cols-1 gap-3 lg:grid-cols-3">
            <img
              class="object-cover"
              src="{{ asset('src/assets/images/mission-family.jpg')}}"
              alt="Family in living room"
            />
            <img
              class="object-cover"
              src="{{ asset('src/assets/images/mission-interior.jpg')}}"
              alt="Interior"
            />
            <img
              class="object-cover"
              src="{{ asset('src/assets/images/mission-materials.jpg')}}"
              alt="Materials"
            />
          </div>
          <p class="py-3">
