...
<header class="mx-auto flex h-16 max-w-[1200px] items-center justify-between px-5">
  ...
  <div class="hidden gap-3 md:!flex">
    <a href="{{ route('wishlist.index') }}" class="flex cursor-pointer flex-col items-center justify-center">
      <svg xmlns="http://www.w3.org/2000/svg" fill="{{ $wishlistCount == 0 ? 'none' : '#ef4444' }}" viewBox="0 0 24 24" stroke-width="1.5" stroke="{{ isset($wishlistCount) && $wishlistCount > 0 ? '#ef4444' : 'currentColor' }}"
        class="h-6 w-6 wishlist-icon">
        <path stroke-linecap="round" stroke-linejoin="round"
